    ...
    f.extend({
        ...
        (f.support = (function () {
            ...
            o.appendChild(a),
                ...
                "zoom" in a.style &&
                    ((a.style.display = "inline"), (a.style.zoom = 1), (k.inlineBlockNeedsLayout = a.offsetWidth === 2), (a.style.display = ""), (a.innerHTML = "<div style='width:4px;'></div>"), (k.shrinkWrapBlocks = a.offsetWidth !== 2)),
                ...
                c.defaultView &&
                    ...
                    a.appendChild(j),
                    (k.reliableMarginRight = (parseInt((c.defaultView.getComputedStyle(j, null) || { marginRight: 0 }).marginRight, 10) || 0) === 0));
            ...
            f(function () {
                ...
                !m ||
                    ...
                    (h = { doesNotAddBorder: d.offsetTop !== 5, doesAddBorderForTableAndCells: g.offsetTop === 5 }),
            ...
            if (!(a.nodeType === 3 || a.nodeType === 8 || !c || !d || !(h = f._data(a)))) {
                ...
                for (k = 0; k < c.length; k++) {
                    (l = E.exec(c[k]) || []),
                        ...
                        (s = f.event.special[m] || {}),
                        (o = f.extend({ type: m, origType: l[1], data: e, handler: d, guid: d.guid, selector: g, namespace: n.join(".") }, p)),
    ...
    (bY = bT.exec(bX.toLowerCase()) || []),
        ...
        f.extend({
            ...
            ajaxSettings: {
                ...
                processData: !0,
                async: !0,
                accepts: { xml: "application/xml, text/xml", html: "text/html", text: "text/plain", json: "application/json, text/javascript", "*": bZ },
              ...
              while ((b = b.parentNode) && b !== i && b !== h) {
                  ...
                  (c = j ? j.getComputedStyle(b, null) : b.currentStyle),
                      ...
                      b === d &&
                          ((l += b.offsetTop),
                          (m += b.offsetLeft),
                          f.support.doesNotAddBorder && (!f.support.doesAddBorderForTableAndCells || !cy.test(b.nodeName)) && ((l += parseFloat(c.borderTopWidth) || 0), (m += parseFloat(c.borderLeftWidth) || 0)),
                          (e = d),
                          (d = b.offsetParent)),
