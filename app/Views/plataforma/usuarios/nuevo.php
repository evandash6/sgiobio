                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row mt-3 align-items-end">
                                ...
                                <div class="col-4">
                                    ...
                                    <select required name="perfil_id" class="form-control select2"><?=$perfil_opc?></select>
                                </div>
                            </div>
                            <div class="row mt-3">
...
<script>
    ...
    $('body').on('click','.btx-send',function(){
        ...
        if(forms[0].reportValidity() === false){
            ...
            api.post('<?=base_url()?>Usuarios/save_usuario',formData,true)
            .done(function(data){
                let res = JSON.parse(data);
                if(res.status == 201){
                    alertf('Cuenta SGI-Biodiversidad creada!!','','success',function(){
                        location.href = '<?=base_url()?>Usuarios';
                    });
                }
                else if(res.status == 200){
                    alertf('Cuenta SGI-Biodiversidad actualizada!!','','success',function(){
                        location.href = '<?=base_url()?>Usuarios';
                    });
                }
                else{
